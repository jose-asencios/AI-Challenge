...
def guardar_diccionario_en_bd(dic_referencia, ruta_bd):
    ...
    for identidad, embeddings in dic_referencia.items():
        ...
        if resultado is None:
            ...
            #embeddings_nuevos = np.concatenate([np.expand_dims(embeddings_antiguos, axis=0), embeddings], axis=0)
    ...
    if request.method == 'POST':
        ...
        if nombre and imagen:
            ...
            imagen.save(path_imagen)
             ...
             # Actualizar la base de datos y el diccionario de referencias
            dic_referencias[nombre] = crear_diccionario_referencias(
